...
#M MSMARCO
train_vec="data/biasbios/vectors_extracted_from_trained_models/mcontriever-msmarco/seed_0/train.vectors_raw_mcontriever.pt"
dev_vec="data/biasbios/vectors_extracted_from_trained_models/mcontriever-msmarco/seed_0/dev.vectors_raw_mcontriever.pt"
test_vec="data/biasbios/vectors_extracted_from_trained_models/mcontriever-msmarco/seed_0/test.vectors_raw_mcontriever.pt"

## probe and report to wandb (in summary stats)
python run_MDL_probing_wrapper.py --model contriever --contriever_type mcontriever-msmarco --model_seed 0 --seed 0 \
