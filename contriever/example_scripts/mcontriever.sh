...
TDIR=contriever/encoded-data/bert-base-multilingual-cased/
...
srun anaconda3/envs/pytorch10/bin/python3 contriever/train.py \
        --model_path $mp \
        ...
        --output_dir contriever/xling/$name \
        --main_port $port \
